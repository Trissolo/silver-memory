...
export class Preloader extends Scene
{
    ...
    preload ()
    {
        ...
        this.load.atlas('atlasbase', 'atlasbase_frame_resized.png', 'atlasbase_frame_resized.json');
    ...
    makeRetroFont()
    {
        ...
        const config = {
            ...
            charsPerRow: 26,
            // use 'offset.x' and 'offset.y' WHEN the Atlas has been generated by 'TexturePacker online app'.
            'offset.x': cutX - 1,
            'offset.y': cutY - 1  
        };
