...
class TestScene extends Phaser.Scene {
    ...
    preload()
    {
        ...
        // this.load.binary('mio', 'assets/defu.thf', Uint8Array);
        // this.load.binary('mio', 'assets/default.thf', Uint8Array);
        // this.load.binary('mio', 'assets/abcdefg.thf', Uint8Array);
        // this.load.binary('mio', 'assets/marco_polo_gioco_da_tavolo.thf', Uint8Array);
